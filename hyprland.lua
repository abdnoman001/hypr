--Plugins
-- hl.exec_cmd("hyprctl plugin load /var/cache/hyprpm/tamim/hyprland-plugins/hyprbars.so")
...
for w = 1, 4 do
    hl.workspace_rule({ workspace = tostring(w), persistent = true })
end
